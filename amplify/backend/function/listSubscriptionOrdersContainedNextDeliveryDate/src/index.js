  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const variables = !isOperator
        ? Object.assign(Object.assign({}, baseVariables), { filter: filter })
        : baseVariables;
      ...
      const nextDeliveryDateItems = items.map((item) => {
        // 次回発送予定年月を計算した値
        const nextDeliveryYearMonth = (0, generate_next_delivery_year_month_1.generateNextDeliveryYearMonth)(
