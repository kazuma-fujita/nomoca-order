...
describe('isFilterWithDeliveryMonth', () => {
  ...
  test('deliveryMonth = 1, deliveryStartMonth = 2, deliveryInterval = 1', () => {
    const result = isFilterWithDeliveryMonth(1, 2, 1);
    expect(result).toBeTruthy();
  });

  test('deliveryMonth = 12, deliveryStartMonth = 1, deliveryInterval = 1', () => {
    const result = isFilterWithDeliveryMonth(12, 1, 1);
    expect(result).toBeTruthy();
  });
