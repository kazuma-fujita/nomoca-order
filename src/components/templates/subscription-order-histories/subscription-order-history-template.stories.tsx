...
import { SubscriptionOrderHistoryTemplate } from './subscription-order-history-template';
...
const Wrapper: React.FC<FetchResponse> = (props) => (
  <SubscriptionOrderHistoryListContextProvider mockResponse={props}>
...
export default { title: ScreenName.subscriptionOrderHistory, component: Wrapper };
