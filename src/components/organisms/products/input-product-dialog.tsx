...
import { ProductNameTextField } from 'components/atoms/product-name-text-field';
...
type Props = {
  ...
  cancelHandler: () => void;
  useFormReturn: UseFormReturn<Product, object>;
  name?: string;
};

export const InputProductDialog = (props: Props) => {
  return (
    <Dialog open={props.on}>
      <Form onSubmit={props.submitHandler}>
        ...
        <DialogContent>
          ...
          <Box mt={2} mb={2}>
            <ProductNameTextField {...props.useFormReturn} disabled={props.isLoading} name={props.name} />
          </Box>
        </DialogContent>
        <DialogActions>
